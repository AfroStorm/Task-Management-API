...
#         # Creates a list based on the suggested positions and team members
#         # query object from the response data retrieved task group to compare
#         # it to the expected data
#         task_id = response.data['id']
